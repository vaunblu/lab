...
}>({ status: "", setStatus: () => null, isDark: false, setDark: () => null });
...
function DropdownItem(props: {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "flex cursor-pointer items-center gap-3 rounded-full px-2 py-1 transition-colors duration-500 hover:bg-white/10",
        props.className,
      )}
    >
      {props.children}
...
function InnerContent() {
  ...
  return (
    <div
      className={cn(
        "relative flex h-full flex-col overflow-hidden rounded-[51px] bg-[#fafafa]",
        isDark && "bg-[#1f1f1f]",
      )}
    >
      <motion.div
        ...
        className={cn(
          "relative origin-top bg-[#FAFAFA] font-medium text-[#1F1F1F]",
          isDark && "bg-[#1f1f1f] text-[#fafafa]",
        )}
      >
          ...
          <div className="relative space-y-1 overflow-hidden pt-4">
            ...
            <DropdownItem className="justify-between pr-1">
              ...
              <motion.button
                ...
                className="relative flex items-center rounded-full bg-muted-foreground/20 p-0.5 text-sm"
              >
                <motion.div
                  className={cn(
                ...
                />
                <div className="z-10 rounded-full px-2 py-0.5">Light</div>
                <div className="z-10 rounded-full px-2 py-0.5">Dark</div>
              </motion.button>
            </DropdownItem>
            <DropdownItem>
              <Bolt
        ...
        <div className="relative flex h-screen flex-col px-6 py-4 leading-relaxed">
          <Image
        ...
        <motion.div
          ...
          className={cn(
            "absolute bottom-0 left-0 w-full bg-gradient-to-t from-[#FAFAFA]",
            isDark && "from-[#1f1f1f]",
          )}
        />
        <motion.div
...
export default function HomePage() {
  ...
  return (
    <Context.Provider value={{ status, setStatus, isDark, setDark }}>
        ...
        <main className="flex h-screen select-none items-center justify-center overflow-hidden">
          <div
            className={cn(
              ...
              isDark && "from-black from-20% to-[#1f1f1f]",
            )}
          >
