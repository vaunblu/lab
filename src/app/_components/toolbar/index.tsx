  ...
  return (
    <MotionConfig transition={{ type: "spring", bounce: 0, duration: 0.4 }}>
      <motion.div
        ...
        className="relative flex gap-2 divide-x overflow-hidden rounded-xl border shadow-lg"
      >
        <div ref={ref} className="relative flex gap-2 divide-x">
          ...
          <motion.div
            layout
            className="flex items-center justify-center bg-background p-2.5"
          >
