...
function InnerContent() {
  ...
  return (
    <div className="relative h-[300px] w-[600px] overflow-visible">
      <div className="size-full absolute bottom-0 left-0 bg-[radial-gradient(circle,#dcd8ff_0%,transparent_100%)] bg-[size:100%_75%] bg-[position:50%_90%] bg-no-repeat opacity-50 blur-xl [mask:radial-gradient(circle_at_center,black_0%,transparent_70%)]" />
      ...
      <div className="size-full absolute bottom-0 left-0 bg-[radial-gradient(circle,#f5f1ff_20%,#dcd8ff_100%)] bg-[size:50px_60px] bg-[position:50%_90%] bg-no-repeat opacity-100 blur-lg [mask:radial-gradient(circle_at_center,black_0%,transparent_70%)]" />
    </div>
  );
}
