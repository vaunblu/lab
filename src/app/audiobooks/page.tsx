    ...
    <div className="size-[720px] flex flex-col justify-between overflow-hidden rounded-[120px] bg-[#E3E3E3] p-10 font-[510] leading-none -tracking-[0.2rem]">
      ...
      >
        <li className="size-[420px] relative flex flex-col justify-end rounded-[80px] border border-black/10 bg-black/[7%] p-10">
          <div className="absolute -top-[96px] left-1/2 h-[320px] w-[214px] -translate-x-1/2 overflow-hidden rounded-l-[2px] rounded-r-[8.5px] shadow-[0_13px_28px_0_rgba(0,0,0,0.09),0_50px_50px_0_rgba(0,0,0,0.07),0_112px_66px_0_rgba(0,0,0,0.04),0_200px_80px_0_rgba(0,0,0,0.01)]">
            <Image src={imageFarewell} alt="Farewell" className="size-full" />
            <div className="size-full absolute left-0 top-0 rounded-l-[2px] rounded-r-[8.5px] shadow-[0_0_0_2px_rgba(0,0,0,0.1)_inset]" />
          </div>
        ...
        <li className="size-[420px] relative flex flex-col justify-end rounded-[80px] border border-black/10 bg-black/[7%] p-10">
          <div className="absolute -top-[96px] left-1/2 h-[320px] w-[214px] -translate-x-1/2 overflow-hidden rounded-l-[2px] rounded-r-[8.5px] shadow-[0_13px_28px_0_rgba(0,0,0,0.09),0_50px_50px_0_rgba(0,0,0,0.07),0_112px_66px_0_rgba(0,0,0,0.04),0_200px_80px_0_rgba(0,0,0,0.01)]">
            <Image src={imageDune} alt="Dune" className="size-full" />
            <div className="size-full absolute left-0 top-0 rounded-l-[2px] rounded-r-[8.5px] shadow-[0_0_0_2px_rgba(0,0,0,0.1)_inset]" />
          </div>
          <div className="space-y-5">
            <div className="space-y-2.5">
